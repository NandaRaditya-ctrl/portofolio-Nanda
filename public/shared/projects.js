document.addEventListener('DOMContentLoaded',()=>{
    ...
    if(!month)return;
    const links=['/bulan-1/index.html','/bulan-2/index.html','/bulan-3/index.html','/bulan-4/index.php','/bulan-5/index.php','/bulan-6/index.php','/bulan-7/index.php','/bulan-8','/bulan-9','/bulan-10','/bulan-11','/bulan-12'];
    ...
    const home=document.createElement('a');home.href='/#timeline';home.textContent='← Portofolio';
